...
namespace Middleware.RegistrarAlt {
    ...
    public partial class RegistrarAlt : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/EndPointReflector", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped, Use=System.Web.Services.Description.SoapBindingUse.Literal)]
        public string EndPointReflector() {
            object[] results = this.Invoke("EndPointReflector", new object[0]);
            return ((string)(results[0]));
        }
        
        public System.IAsyncResult BeginEndPointReflector(System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("EndPointReflector", new object[0], callback, asyncState);
        }
        
        public string EndEndPointReflector(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((string)(results[0]));
        }
        ...
        public void EndPointReflectorAsync(object userState) {
            if ((this.EndPointReflectorOperationCompleted == null)) {
                this.EndPointReflectorOperationCompleted = new System.Threading.SendOrPostCallback(this.OnEndPointReflectorCompleted);
            }
            this.InvokeAsync("EndPointReflector", new object[0], this.EndPointReflectorOperationCompleted, userState);
        }
        
        private void OnEndPointReflectorCompleted(object arg) {
    ...
    public delegate void EndPointReflectorCompletedEventHandler(object sender, EndPointReflectorCompletedEventArgs args);
}
