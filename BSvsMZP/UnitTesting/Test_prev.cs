...
namespace UnitTesting
{
	...
	public class Test_prev
	{
		...
		public void Communicator ()
		{
			...
			// Making an evelope
			Envelope env = new Envelope (msg, ep);
			...
			// getting the buffer
			List<Envelope> envList = comm1.getEnvelopes();
		...
		public void Listener ()
		{
			...
			Listener listener = new Listener (comm1, msgQueue);
		...
		public void MessageQueque ()
		{
			...
			msgQueue.convoInProgressQueue.TryAdd(convoKey, new System.Collections.Concurrent.ConcurrentQueue<Envelope>());
